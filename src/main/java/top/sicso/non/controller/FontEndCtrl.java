package top.sicso.non.controller;//package me.qyxz.blog.controller;
//
...
//import me.qyxz.blog.service.inter.InfoSer;
//import me.qyxz.blog.service.inter.ProjectSer;
...
//        model.addAttribute("info",infoSer.getInfo());
//        List<Blog> views=blogSer.getBlogByTag(tagName);
...
//        model.addAttribute("info",infoSer.getInfo());
//        Blog blogView=blogSer.getBlog(id);
//        Blog prev=blogSer.getPrevBlog(id);
//        Blog next=blogSer.getNextBlog(id);
