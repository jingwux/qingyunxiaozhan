...
$(function () {
    ...
    $("#add-blog").bind("click", function () {
        ...
        a.action = "/admin/blog/add", a.method = "post", document.blogForm.article.value = $(".markdown-body")[0].innerHTML, document.blogForm.md.value = mdEditor.getMarkdown(), a.submit()
    });
    $("#update-blog").bind("click", function () {
        var a = document.forms[0];
        a.action = "/admin/blog/update";
        a.method = "post";
