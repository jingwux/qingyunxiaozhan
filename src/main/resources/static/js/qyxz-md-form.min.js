...
$(function () {
    ...
    mdEditor = editormd("markdown-editor", {
        ...
        a.action = "/admin/addBlog", a.method = "post", document.blogForm.article.value = $(".markdown-body")[0].innerHTML, document.blogForm.md.value = mdEditor.getMarkdown(), a.submit()
    }), $("#update-blog").bind("click", function () {
        var a = document.forms[0];
        a.action = "/admin/updateBlog", a.method = "post", document.blogForm.article.value = $(".markdown-body")[0].innerHTML, document.blogForm.md.value = mdEditor.getMarkdown(), a.submit()
