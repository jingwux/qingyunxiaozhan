...
$(function () {
    ...
    mdEditor = edit ormd("markdown-editor", {
        width: "100%",
        height: 900,
        ...
        imageUploadURL: "/admin/file/picture",
    ...
    $("#add-blog").bind("click", function () {
        ...
        a.action = "/admin/blog", a.method = "post", document.blogForm.article.value = $(".markdown-body")[0].innerHTML, document.blogForm.md.value = mdEditor.getMarkdown(), a.submit()
    });
